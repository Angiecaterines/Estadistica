...
# Detección y conteo de NA's por filas o por columnas. --------------------
...
totalcol.NA<-apply(dat1,2,function(x)sum(is.na(x)))


# Visualización de valores faltantes en R ---------------------------------

# Distribución de los NA's en el conjunto de datos (Missing plot)
Amelia::missmap(obj=dat1,col=c("cyan","blue"),rank.order = F,legend = T)
...
# Imputación simple por la media y/o mediana observada --------------------
